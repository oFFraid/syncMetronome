...
public class NTPRequest implements Serializable {
    ...
    private long t1 = 0; //time at client
    private long t2 = 0; //time at server when client request was received
    private long t3 = 0; //time at server after adding random delay
    private long t4 = 0; //time at client when server response was received
    private double o = 0;
    private double d = 0;
    ...
    public void doFinalDelayCalculation(){
        System.out.println("------------------------");
        System.out.println("Selected time difference   : " + this.getD());
        System.out.println("Corresponding clock offset : " + this.getO());
